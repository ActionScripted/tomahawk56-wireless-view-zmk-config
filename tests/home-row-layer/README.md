...
| 2 deliberate-layer-chord | a chord started before the 175 ms term still resolves, on the target key's release |
...
| 9 held-alone-then-chord | held 180 ms, a same-hand chord proves the 175 ms term has engaged the layer |
...
Cases 8 and 9 bracket the 175 ms tapping term from both sides; keep them together
if that value is ever retuned.
